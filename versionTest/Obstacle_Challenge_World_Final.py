        ...
        while True:
            ...
            if counter == last_counter and not lap_finish:
                ...
                if not finished:
                    if orange_flag:
                        if parking_right:
                            target_count = counts.value + 26000 #22000 - finish too late in the section
                        elif parking_left: 
                        ...
                        if parking_right:
                            ...
                            target_count = counts.value + 26000
                    finished = True
                    ...
                    if STATE == 3:
                        if full_park:
                            ...
                            if blue_flag:
                                ...
                                final_park = time.time()
                                correctReverseAngle( heading_angle, head.value, 3)
                                while (parking_distance > 20) or abs(corr) > 5 and (time.time() - final_park < 1.8):
                                    tfmini.getTFminiData()
                                    if parking_right:
                                        parking_distance = tfmini.distance_right
                                    elif parking_left:
