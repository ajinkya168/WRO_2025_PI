                                ...
                                if g_flag:
                                    ...
                                    if blue_flag:
                                        if counter % 4 == pink_wall_lane :
                                            ...
                                            if ( tf_r <= 55 and tf_r > 0 and not green_b.value) or (time.time() - green_time > avoid_thres):
                                                print('Obstacle STATE changed to 3')
                                                g_flag = False
                                                OBSTACLE_STATE = 3
                                                buff_time = time.time()                                            
                                        ...
                                        if counter % 4 == pink_wall_lane :
                                            avoid_thres = 0.7
                                            if ( tf_r <= 55 and tf_r > 0) or (time.time() - green_time > avoid_thres): 
                                                g_flag = False
                                                OBSTACLE_STATE = 3
                                                buff_time = time.time()
                                                print('Obstacle STATE changed to 3')
                                    ...
                                    if orange_flag:
                                        if counter % 4 == pink_wall_lane :
                                            ...
                                            if ( tf_l <= 55 and tf_l > 0 and not red_b.value) or (time.time() - red_time > avoid_thres):
                                                print('Obstacle STATE changed to 3')
                                                r_flag = False
                                                OBSTACLE_STATE = 3
                                                buff_time = time.time()                                            
                                        ...
                                        if counter % 4 == pink_wall_lane :
                                            avoid_thresh = 0.7
                                            if ( tf_l <= 55 and tf_l > 0) or (time.time() - red_time > avoid_thres): 
                                                r_flag = False
                                                OBSTACLE_STATE = 3
                                                buff_time = time.time()
                                                print('Obstacle STATE changed to 3')
