				...
				if reset_f:
					...
					if block_list[-1] == 'red':
						...
						if ((green_b.value or green_turn) and (color_sensor == "White")) and (distance_head > 35):
							...
							correctPosition(0, heading_angle, x, y, trigger, counter, g_flag, r_flag)
						else:
					...
					if green_b.value and not r_flag:
						...
						if distance_right < 50 or g_past:
					...
					if g_flag:
						...
						correctPosition(setPointL, heading_angle, x, y, trigger, counter, g_flag, r_flag)
					...
					# elif(red_b.value and not trigger and time.time() - green_time >= 0.5):
						...
						green_stored = False
						correctPosition(
							setPointR, heading_angle, x, y, trigger, counter, g_flag, r_flag)
